...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      var option, results, results_group, searchText, words, _i, _len, _ref;
    ...
    AbstractChosen.prototype.search_string_match = function(search_string, words) {
      var word, _i, _len;
    ...
    AbstractChosen.prototype.split_search_text = function(text) {
      var word, words, _i, _len, _ref;
      words = [];
      _ref = text.toLowerCase().split(' ');
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        word = _ref[_i];
        if (word.trim() !== "") {
          words.push(word);
    ...
    AbstractChosen.prototype.highlight_search_text = function(text, words) {
      var highlight_offset, startpos, word, _i, _len;
